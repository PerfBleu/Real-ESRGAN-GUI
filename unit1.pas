...
begin
      ...
      begin
        case videostepcounter of
          0 : begin
                ...
                Form1.StatusBar1.Panels.Items[1].Text:='Video process 1/3 [Extracting frames]:'+ffmpeg + command_tail;
                steps += 1;
          ...
          1 : begin
                ...
                Form1.StatusBar1.Panels.Items[1].Text:='Video process 2/3 [Enlarging frames]:'+commandhead + command_tail + extra_cmd_paras;
                steps += 1;
                //videostepcounter := videostepcounter + 1;
                //videoFFpending := True;
          ...
          2 : begin
                ...
                Form1.MemoLog.Append(ffmpeg+command_tail);
                Form1.StatusBar1.Panels.Items[1].Text:='Video process 3/3 [Combining frames]:'+commandhead + command_tail + extra_cmd_paras;
                //videoFFpending:=True;
                steps += 1;
                proc.Open(ffmpeg, command_tail);
              end;
  ...
  begin
    ...
    Form1.StatusBar1.Panels.Items[0].Text:='IDLE';
    Form1.StatusBar1.Panels.Items[1].Text:='DONE!';
    enable_start;
  end;
end;
